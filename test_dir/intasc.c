/******************************************************************************/
/*                                                                            */
/* intasc.c     Convert a binary number to 1-5 ASCII string         R01-01.00 */
/*                                                                            */
/* ========================================================================== */
/*                                                                            */
/* Purpose:                                                                   */
...
/**void intasc_(unsigned char * asc, short      * ival, short      * bcnt) **/
void intasc_(unsigned char * asc, int      * ival, short      * bcnt)
{
  int                 index;
  int                 offset;
  int                 value;
...
#if 0
  dLog(DLOG_STDLOG,"INTASC :  input=%d  return=%s, count= %d",*ival,asc,*bcnt);
#endif
  return;
}
...
/*  short            value; */
  ...
  for(index=1;index<argc;index+=2) {
    ...
    dLog(DLOG_STDLOG,"bcnt %d",bcnt);
    value  = atoi(argv[index+1]);
    length = strlen(argv[index+1]);
    dLog(DLOG_STDLOG,"value %d bcnt %d",value,bcnt);
